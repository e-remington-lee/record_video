...
from PySide2.QtWidgets import QAction, QMainWindow, QApplication, QPushButton
...
class RunModelWindow(QMainWindow):
    ...
    def __close_box(self):
        if RunModelWindow.face_box:
            self.__stop_program()
            RunModelWindow.face_box.close_window()
            self.box_drawn_can_start = False
            print("---closing box---")
